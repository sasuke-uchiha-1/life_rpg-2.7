      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {activeTab === 'dashboard' && (
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <h3 className="text-2xl font-bold text-white mb-6">Progress Snapshot</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-gray-800/30 rounded-lg">
                  <div className="text-2xl font-bold text-cyan-400 mb-1">{currentLevel}</div>
                  <div className="text-sm text-gray-400">Level</div>
                </div>
                <div className="text-center p-4 bg-gray-800/30 rounded-lg">
                  <div className="text-2xl font-bold text-blue-400 mb-1">{currentXP.toLocaleString()}</div>
                  <div className="text-sm text-gray-400">Total XP</div>
                </div>
                <div className="text-center p-4 bg-gray-800/30 rounded-lg">
                ...
                <div className="text-center p-4 bg-gray-800/30 rounded-lg">
                  <div className="text-2xl font-bold text-green-400 mb-1">{skillsData.reduce((sum, skill) => sum + skill.level, 0)}</div>
